...
**Scope.** The dataset used here contains **62 daily files
totalling 19.38 GB on disk**.
...
| Optimized (float32 / int32 / usecols) |            0.5  |                157   |            307.9 |
| Parquet (snappy)                      |            0.17 |                157   |             61.9 |

Memory reduced by **46.9%**; disk reduced by
**79.9%**. The full Parquet cache occupies
**3.84 GB** and reloads each daily file ~70× faster
...
![Distribution of total Internet traffic across the 10,000 geographical areas.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/eda/traffic_distribution.png)

*Distribution of total Internet traffic across the 10,000 geographical areas.*

Total Internet traffic per area over the two-month period is strongly
right-skewed (skewness = **4.27**, kurtosis = **25.52**). A small
...
account for **11.0%** of all Internet traffic. The
...
over the full observation period are **Squares 5161, 5059, 5259**. For the
assignment's required comparison, Squares **4159 and 4556** are
also plotted.

![Internet traffic time series during the first two weeks for the three highest-traffic areas.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/eda/top_areas.png)

*Internet traffic time series during the first two weeks for the three highest-traffic areas.*

![Internet traffic time series during the first two weeks for Squares 4159 and 4556.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/eda/required_areas_first_two_weeks.png)

*Internet traffic time series during the first two weeks for Squares 4159 and 4556.*
...
of 1,426.98 CDRs/interval, while Square 4159 has a mean of only
274.88 CDRs/interval. Square 4159 also shows more erratic
...
![ACF and PACF of the highest-traffic area (Square 5161).](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/eda/acf_pacf.png)

*ACF and PACF of the highest-traffic area (Square 5161).*
...
![STL decomposition of the highest-traffic area with period = 144.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/eda/seasonality.png)

*STL decomposition of the highest-traffic area with period = 144.*

STL decomposition shows that daily seasonality explains the majority of
variance — **86.4%** of total variance is captured by trend and
...
| Model   |      MAE |   MAPE (%) |    RMSE |
|:--------|---------:|-----------:|--------:|
| SARIMA  |  91.2399 |     9.1611 | 131.328 |
| LSTM    |  82.8152 |     9.8189 | 118.779 |
| CNN     | 233.856  |    39.2126 | 295.709 |

**Square 5059**

| Model   |      MAE |   MAPE (%) |    RMSE |
|:--------|---------:|-----------:|--------:|
| SARIMA  |  83.3136 |     7.8696 | 115.761 |
| LSTM    |  72.2333 |     7.4304 | 101.473 |
| CNN     | 150.576  |    19.6824 | 191.732 |

**Square 5259**

| Model   |      MAE |   MAPE (%) |    RMSE |
|:--------|---------:|-----------:|--------:|
| SARIMA  |  83.6348 |     8.5505 | 125.334 |
| LSTM    |  72.8834 |     8.3038 | 111.632 |
| CNN     | 321.492  |    50.8633 | 389.263 |

### 6.2 Prediction plots

Nine superposed plots — three models × three areas:

![SARIMA predictions on Square 5161 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/sarima_area_5161.png)

*SARIMA predictions on Square 5161 during the test week.*
![LSTM predictions on Square 5161 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/lstm_area_5161.png)

*LSTM predictions on Square 5161 during the test week.*
![CNN predictions on Square 5161 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/cnn_area_5161.png)

*CNN predictions on Square 5161 during the test week.*

![SARIMA predictions on Square 5059 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/sarima_area_5059.png)

*SARIMA predictions on Square 5059 during the test week.*
![LSTM predictions on Square 5059 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/lstm_area_5059.png)

*LSTM predictions on Square 5059 during the test week.*
![CNN predictions on Square 5059 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/cnn_area_5059.png)

*CNN predictions on Square 5059 during the test week.*

![SARIMA predictions on Square 5259 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/sarima_area_5259.png)

*SARIMA predictions on Square 5259 during the test week.*
![LSTM predictions on Square 5259 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/lstm_area_5259.png)

*LSTM predictions on Square 5259 during the test week.*
![CNN predictions on Square 5259 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/forecasts/cnn_area_5259.png)

*CNN predictions on Square 5259 during the test week.*

### 6.3 Training and execution time

| Model   | Training time (s)   | Execution time (s)   |
|:--------|:--------------------|:---------------------|
| CNN     | 69.96 ± 15.04       | 79.39 ± 2.12         |
| LSTM    | 195.40 ± 1.57       | 91.56 ± 4.02         |
| SARIMA  | 0.08 ± 0.01         | 45.90 ± 4.40         |

**Hardware.** All experiments were executed on
**Windows 11 (10.0.26200)**, processor **Intel64 Family 6 Model 154, 12 cores**, with
**15.73 GB RAM** and no GPU acceleration (TensorFlow-CPU
...
(mean MAE = **75.977**), followed by SARIMA
(mean MAE = **86.063**) and CNN
(mean MAE = **235.308**). This ranking is consistent across all
...
![Residuals of the three models on Square 5161 during the test week.](C:/Users/favor/Downloads/trial_formative-1/trial_formative-4/figures/errors/worst_prediction.png)

*Residuals of the three models on Square 5161 during the test week.*

The worst 1-hour window per model × area is summarised below.

|   Area | Model   | Start               | End                 |   1h MAE |
|-------:|:--------|:--------------------|:--------------------|---------:|
|   5161 | SARIMA  | 2013-12-17 14:10:00 | 2013-12-17 15:00:00 |   270.6  |
|   5161 | LSTM    | 2013-12-17 14:30:00 | 2013-12-17 15:20:00 |   376.45 |
|   5161 | CNN     | 2013-12-16 09:10:00 | 2013-12-16 10:00:00 |   837.6  |
|   5059 | SARIMA  | 2013-12-20 22:40:00 | 2013-12-20 23:30:00 |   287.92 |
|   5059 | LSTM    | 2013-12-21 17:40:00 | 2013-12-21 18:30:00 |   249.78 |
|   5059 | CNN     | 2013-12-21 07:20:00 | 2013-12-21 08:10:00 |   506.21 |
|   5259 | SARIMA  | 2013-12-19 11:40:00 | 2013-12-19 12:30:00 |   294.94 |
|   5259 | LSTM    | 2013-12-16 00:00:00 | 2013-12-16 00:50:00 |   429.38 |
|   5259 | CNN     | 2013-12-16 07:40:00 | 2013-12-16 08:30:00 |   974.44 |
